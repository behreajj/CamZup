...
/**
 * Holds mathematical constants used by the rest of the library.
 * Provides convenience functions for printing a hash code and
 * identity hash code as hexadecimal strings.
 */
public interface IUtils {
  ...
  /**
   * Four-thirds, 4.0 / 3.0 . Approximately 1.3333333 . Useful when
   * creating a circular shape with a series of Bezier curves.
   */
  float FOUR_THIRDS = 1.3333333f;

  /**
   * Four-thirds, 4.0 / 3.0 . Approximately 1.3333333333333333 . Useful
   * when creating a circular shape with a series of Bezier curves.
   */
  double FOUR_THIRDS_D = 1.3333333333333333d;

  /**
   * An approximation of \u03c4 / \u03c6<sup>2</sup> , 2.3999631 .
   ...
   * . Useful for replicating phyllotaxis. In degrees,
   * 137.50776405003785 .
   */
   ...
   * space to one in HSB, given the six sectors formed by primary and
   * secondary colors . Approximately 0.16666667 .
   */
   ...
   * One-sixth, 1.0 / 6.0 . Useful when converting a color in RGB color
   * space to one in HSB, given the six sectors formed by primary and
   * secondary colors . Approximately 0.16666666666666667 .
   */
   ...
   * quaternions. Approximately 0.07957747 .
   */
  float ONE_TAU_2 = 0.07957747154594767f;

  /**
   * 1.0 / 4.0 \u03c0 . Useful when normalizing angles supplied to
   * quaternions. Approximately 0.07957747154594767 .
   */
  ...
  /**
   * One-third, 1.0 / 3.0 . Approximately 0.33333333 . Useful for
   * setting handles on the knot of a Bezier curve.
   */
  float ONE_THIRD = 0.33333334f;

  /**
   * One-third, 1.0 / 3.0 . Approximately 0.3333333333333333 . Useful
