...
public class Knot3 implements Cloneable, Comparable < Knot3 > {
  ...
  /**
   * Rotates this knot around an axis by an angle in radians. The axis
   * is assumed to be of unit length. Accepts pre-calculated sine and
  ...
  /**
   * Rotates a knot around the x axis. Accepts calculated sine and
   * cosine of an angle, so that collections of knots can be efficiently
   * rotated without repeatedly calling cos and sin.
   *
   * @param cosa cosine of the angle
  ...
  /**
   * Rotates a knot around the y axis. Accepts calculated sine and
   * cosine of an angle, so that collections of knots can be efficiently
   * rotated without repeatedly calling cos and sin.
   *
   * @param cosa cosine of the angle
  ...
  /**
   * Sets the knot's coordinate, fore handle and rear handle by
   * component.
   *
   * @param xCoord the x coordinate
   * @param yCoord the y coordinate
   ...
   */
  public static Knot3 fromSegCubic (
      final Vec3 prevControl,
      final Vec3 nextControl,
   ...
   * @return the current knot
   */
  public static Knot3 smoothHandlesFinal (
      final Knot3 prev,
      final Knot3 curr,
      final Vec3 dir ) {
   ...
   * @return the current knot
   */
  public static Knot3 smoothHandlesInitial (
      final Knot3 curr,
      final Knot3 next,
      final Vec3 dir ) {
