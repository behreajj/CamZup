...
public class Gradient implements IUtils, Cloneable, Iterable < ColorKey > {
   ...
   public String toBlenderCode (
      ...
      final Color[] clrs = Gradient.evalRange(this,
         Utils.clamp(samples, 2, 32));
   ...
   public static Gradient fromGgr (
      ...
      sampling: for ( int k = 0; k < vsmp; ++k ) {
          ...
          * edge of the last key. This will likely amount to step <= 0.0 or step
          * >= 1.0 .
          */
         if ( step <= keyArr[0][0] ) {
   ...
   /**
    * Creates a gradient from an array of strings representing a GIMP color
    * palette (.gpl) .
    *
