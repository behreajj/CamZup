 ...
 * directions in three-dimensional graphics programs. Instance methods
...
public class Vec3 implements Comparable < Vec3 >, Cloneable, Iterable < Float >,
   ...
   * index is 2 or -1, returns z; 1 or -2, y; 0 or -3, x.
   *
  ...
  /**
   * Returns a hash code for this vector based on its x, y and z
   * components.
   *
  ...
  /**
   * Returns a float array of length 3 containing this vector's
   * components.
   *
   * @return the array
   */
  ...
  /**
   * The cross product returns a vector perpendicular to both <em>a</em>
   * and <em>b</em>, and therefore normal to the plane on which
   ...
   * <br>
   *
   * The cross product is anti-commutative, meaning <em>a</em> x
   * <em>b</em> = - ( <em>b</em> x <em>a</em> ) . A unit vector does not
   * necessarily result from the cross of two unit vectors. The 3D
   * equivalent to the 2D vector's perpendicular.
   *
   * @param a      left operand
   * @param b      right operand
   * @param target the output vector
  ...
  /**
   * A specialized form of the cross product which normalizes the
   * result. This is to facilitate the creation of lookAt matrices.
   *
  ...
  /**
   * A specialized form of the cross product which normalizes the
   * result. The unnormalized cross product is disclosed as an output.
   *
   * @param a       left operand
   * @param b       right operand
   * @param target  the output vector
   ...
   * angle in radians, the vector's azimuth; (2) rho, \u03c1, a radius,
   ...
   * the vector is on the equator of the unit sphere.
   *
   * @param azimuth the angle in radians
   * @param target  the output vector
   * @return the vector
   ...
   * azimuth or longitude; (2) phi, \u03c6, the inclination or latitude;
   * (3) rho, \u03c1, the radius or magnitude. Uses the formula<br>
   * <br>
   * ( \u03c1 cos ( \u03b8 ) cos ( \u03c6 ),<br>
   * \u03c1 sin ( \u03b8 ) cos ( \u03c6 ),<br>
   * - \u03c1 sin ( \u03c6 ) )<br>
   * <br>
   * The poles will be upright in a z-up coordinate system; sideways in
   ...
   * Generates a 3D array of vectors. The result is in layer-row-major
   * order, but the parameters are supplied in reverse: columns first,
   * then rows, then layers. Defaults to the coordinate range of [-0.5,
   * 0.5] .
   *
   * @param cols   number of columns
   * @param rows   number of rows
   ...
   * / 2.0] . It is necessary to calculate the vector's magnitude in
   * order to find its inclination.
   *
   * @param v the input vector
   * @return the inclination
  ...
  /**
   * Finds the vector's inclination in the range [3.0 \u03c0 / 2.0,
   * \u03c0 / 2.0] .
   *
   * @param v the input vector
   * @return the inclination
  ...
  /**
   * Tests to see if the vector is on the unit sphere, i.e., has a
   ...
   * referred to as the radius when using spherical coordinates. Uses
  ...
  /**
   * Sets the output vector to the maximum of the input vector and an
   * upper bound.
   *
  ...
  /**
   * Sets the output vector to the maximum components of the input
  ...
  /**
   * Sets the output vector to the minimum components of the input
   ...
   * unit vector, as it lies on the unit sphere.
   *
   * @param v      the input vector
   * @param target the output vector
   ...
   * assumed to be of unit length. Accepts calculated sine and cosine of
  ...
  /**
   * Rotates a vector around the x axis. Accepts calculated sine and
