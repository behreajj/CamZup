 ...
 * <em>very</em> minimal and incomplete. Use only for basic or simplified
 * SVG files, not ones that contain CSS styling (color and materials will
 * not be evaluated anyways) or non-standard XML nodes (including nodes
 * generated by Inkscape and/or Adobe Illustrator).
 */
