 ...
 * ones that contain definition blocks, CSS styling (color and materials
 * will not be evaluated anyways) or non-standard XML nodes (including
 * nodes generated by Inkscape and/or Adobe Illustrator).
 */
public abstract class ParserSvg {
   ...
   /**
    * A helper function to parse an angle to radians. The default input is
