...
abstract class ParserSvg {
   ...
   public static CurveEntity2 parse ( final String fileName ) {
      ...
      try {
         ...
         for ( int i = 0; i < nodeLen; ++i ) {
            ...
            ParserSvg.parseNode(node, result, root);
         }
         ...
         if ( viewbox != null ) {
            ParserSvg.parseViewBox(viewbox, vbVec, widpx, hghpx);
         }
   ...
   private static ArrayList < Curve2 > parseNode ( final Node node,
      ...
      if ( attributes != null ) {
         ...
         if ( transform != null ) {
            ParserSvg.parseTransform(transform, current);
         }
      }
      ...
      switch ( hsh ) {
         ...
         case -1656480802:
            ...
            newCurves.add(ParserSvg.parseEllipse(node, new Curve2()));
            break;
         ...
         case 561938880:
            ...
            newCurves.add(ParserSvg.parsePoly(node, new Curve2()));
            break;

         case 3321844:
            /* "line" */

            newCurves.add(ParserSvg.parseLine(node, new Curve2()));
            break;

         case 3433509:
            /* "path" */

            final Curve2[] cs = ParserSvg.parsePath(node);
         ...
         case 3496420:
            ...
            newCurves.add(ParserSvg.parseRect(node, new Curve2()));
            break;
      ...
      for ( int i = 0; i < childLen; ++i ) {
         ...
         newCurves = ParserSvg.parseNode(child, target, current);
      }
   ...
   private static Curve2[] parsePath ( final Node node ) {
      ...
      if ( attributes != null ) {
         ...
         if ( pathData != null ) {
            ...
            String[] dataTokens = ParserSvg.PATTERN_DATA.split(pdStr, 0);
            dataTokens = ParserSvg.stripEmptyTokens(dataTokens);
            dataTokens = ParserSvg.breakNeg(dataTokens);
            ...
            for ( int l = 0, cursor = -1; l < cmdLen; ++l ) {
               ...
               switch ( command ) {
                  ...
                  case HORIZ_ABS:
                     ...
                     curr.coord.x = ParserSvg.parseFloat(coxStr, 0.0f);
                  ...
                  case HORIZ_REL:
                     ...
                     curr.coord.x = relative.x + ParserSvg.parseFloat(coxStr,
                        0.0f);
                     curr.coord.y = prev.coord.y;
                  ...
                  case VERT_ABS:
                     ...
                     curr.coord.y = ParserSvg.parseFloat(coyStr, 0.0f);
                     Curve2.lerp13(prev.coord, curr.coord, prev.foreHandle);
                     Curve2.lerp13(curr.coord, prev.coord, curr.rearHandle);
                  ...
                  case VERT_REL:
                     ...
                     curr.coord.x = prev.coord.x;
                     curr.coord.y = relative.y + ParserSvg.parseFloat(coyStr,
                        0.0f);
                  ...
                  case CUBIC_TO_ABS:
                     ...
                     prev.foreHandle.set(ParserSvg.parseFloat(fhxStr), ParserSvg
                        .parseFloat(fhyStr));
                     curr.rearHandle.set(ParserSvg.parseFloat(rhxStr), ParserSvg
                        .parseFloat(rhyStr));
                     curr.coord.set(ParserSvg.parseFloat(coxStr), ParserSvg
                        .parseFloat(coyStr));
                  ...
                  case ARC_TO_ABS:
                     ...
                     target.appendAll(ParserSvg.parseArcTo(prev, ParserSvg
                        .parseFloat(rx), ParserSvg.parseFloat(ry), ParserSvg
                           .parseAngle(angle), ParserSvg.parseFlagToBool(fa),
                        ParserSvg.parseFlagToBool(fs), ParserSvg.parseFloat(
                           coxStr), ParserSvg.parseFloat(coyStr)));
                  ...
                  case ARC_TO_REL:
                     ...
                     target.appendAll(ParserSvg.parseArcTo(prev, ParserSvg
                        .parseFloat(rx), ParserSvg.parseFloat(ry), ParserSvg
                           .parseAngle(angle), ParserSvg.parseFlagToBool(fa),
                        ParserSvg.parseFlagToBool(fs), relative.x + ParserSvg
                           .parseFloat(coxStr), relative.y + ParserSvg
                              .parseFloat(coyStr)));
            ...
            switch ( hsh ) {
               ...
               case -1081239615:
                  ...
                  if ( dataLen > 6 ) {
                     ...
                     delta.set(ParserSvg.parseFloat(m00), ParserSvg.parseFloat(
                        m01), ParserSvg.parseFloat(m02), ParserSvg.parseFloat(
                           m10), ParserSvg.parseFloat(m11), ParserSvg
               ...
               case -925180581:
                  ...
                  if ( dataLen > 1 ) {
                     ...
                     Mat3.fromRotZ(ParserSvg.parseAngle(ang), delta);
                     Mat3.mul(target, delta, target);
                  }
               ...
               case 109250890:
                  ...
                  if ( dataLen > 1 ) {
                     ...
                     Mat3.fromScale(ParserSvg.parseFloat(scx), ParserSvg
               ...
               case 109493422:
                  ...
                  if ( dataLen > 1 ) {
                     ...
                     Mat3.fromSkewX(ParserSvg.parseAngle(skx), delta);
                     Mat3.mul(target, delta, target);
                  }
               ...
               case 109493423:
                  ...
                  if ( dataLen > 1 ) {
                     ...
                     Mat3.fromSkewY(ParserSvg.parseAngle(sky), delta);
                     Mat3.mul(target, delta, target);
                  }
               ...
               case 1052832078:
                  ...
                  if ( dataLen > 1 ) {
                     ...
                     Mat3.fromTranslation(ParserSvg.parseFloat(tx), ParserSvg
                        .parseFloat(ty), delta);
                     Mat3.mul(target, delta, target);
                  }
