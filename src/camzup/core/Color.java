 ...
 * Supports conversion to and from integers where color channels are
...
public class Color extends Vec4 {
  ...
  /**
   * Creates a color out of red, green and blue channels. The alpha
  ...
  /**
   * Returns a String representation of the color compatible with .ggr
   * (GIMP gradient) file formats. Each channel, including alpha, is
   * represented as a float in [0.0, 1.0] separated by a space.
   *
   * @return the string
   */
  String toGgrString ( ) {
  ...
  /**
   * Returns a String representation of the color compatible with .gpl
   * (GIMP palette) file formats. Each channel, including alpha, is
   * represented an unsigned byte in [0, 255] separated by a space.
   *
   * @return the string
   */
  String toGplString ( ) {
  ...
  /**
   * Returns -1 when this color is less than the comparisand; 1 when it
   * is greater than; 0 when the two are 'equal'. The implementation of
   * this method allows collections of colors to be sorted.
   *
  ...
  /**
   * Simulates bracket access in an array. The alpha channel is treated
  ...
  /**
   * Sets a color with bytes. In Java, bytes are signed, within the
   * range [-128, 127] .
   *
   * @param red   the red channel
   * @param green the green channel
  ...
  /**
   * Sets the red, green and blue color channels of this color. The
   * alpha channel is set to 1.0 by default.
   *
   * @param red   the red channel
   * @param green the green channel
   * @param blue  the blue channel
  ...
  /**
   * Overrides the parent set function for the sake of making RGB
   * parameters clearer and for chainability.
   *
   * @param red   the red channel
   * @param green the green channel
   * @param blue  the blue channel
   ...
   * retained.
   *
   * For that reason, color addition is <em>not</em> commutative.
   *
  ...
  /**
   * Tests to see if the alpha channel of the color is greater than
   * zero, i.e. if it has some opacity.
   *
   * @param c the color
   * @return the evaluation
   */
  ...
  /**
   * Converts two colors to integers, performs the bitwise AND operation
   * on them, then converts the result to a color.
   *
  ...
  /**
   * Converts a color to an integer, performs the bitwise NOT operation
   * on it, then converts the result to a color.
   *
   ...
   * operation, then converts the result to a color. The number of
   * places is multiplied by 0x08.
   *
   * @param a      the color
  ...
  /**
   * Converts a color to an integer, performs an unsigned bitwise right
   * shift operation, then converts the result to a color. The number of
   * places is multiplied by 0x08.
   *
   * @param a      the color
   * @param places the number of places
   ...
   * channel, then clamps the product to [0.0, 1.0] . The left operand's
  ...
  /**
   * Divides the left operand by the right, except for the alpha
   * channel, then clamps the product to [0.0, 1.0] . The left operand
   * is also supplied to the alpha channel.
   *
   * @param a      left operand, numerator
   * @param b      right operand, denominator
   * @param target output color
  ...
  /**
   * Converts a direction to a color. Normalizes the direction,
   * multiplies it by 0.5, then adds 0.5 .
   *
  ...
  /**
   * Attempts to convert a hexadecimal String to a color. Recognized
   * formats include:
   *
   * <ul>
  ...
  /**
   * Converts from hue, saturation and brightness to a color with red,
  ...
  /**
   * Inverts a color by subtracting the red, green and blue channels
   * from one. Similar to bitNot, except alpha is not affected. Also
   * similar to adding 0.5 to the x component of a Vec4 storing hue,
  ...
  /**
   * Mixes two colors by a step in the range [0.0, 1.0]. Uses the
   * default mixing function.
   *
   ...
   * alpha channel is retained.
   *
   * For that reason, color multiplication is <em>not</em> commutative.
   *
   * @param a      left operand
   * @param b      right operand
   * @param target output color
  ...
  /**
   * Tests to see if the alpha channel of this color is less than or
   * equal to zero, i.e., if it is completely transparent.
   *
   * @param c the color
   * @return the evaluation
   */
  ...
  /**
   * Reduces the signal, or granularity, of a color's channels. Any
   * level less than 2 or greater than 255 returns sets the target to
   * the input.
   *
   * @param c      the color
  ...
  /**
   * Creates a random HSBA vector, then converts it to an RGBA color.
   * The alpha channel is randomized.
   *
   * @param rng    the random number generator
   * @param target the output color
   * @param hsba   the output HSBA vector
  ...
  /**
   * Creates a random color from a lower- and upper-bound. The alpha
   * channel is not included.
   *
   * @param rng        the random number generator
   * @param lowerBound the lower bound
  ...
  /**
   * Shifts a color's brightness by a factor. The brightness is clamped
  ...
  /**
   * Shifts a color's hue, saturation and brightness by a vector. The
   * color's alpha remains unaffected.
   *
   * @param c      the input color
  ...
  /**
   * Shifts a color's hue by a factor. The hue wraps around the range
   * [0.0, 1.0] .
   *
   * @param c      the input color
  ...
  /**
   * Shifts a color's saturation by a factor. The saturation is clamped
   * to the range [0.0, 1.0] .
   *
   * @param c      the input color
  ...
  /**
   * Subtracts the right operand from the left operand, except for the
   * alpha channel, then clamps the sum to [0.0, 1.0] . The left
  ...
  /**
   * Converts a color to an integer where hexadecimal represents the
  ...
  /**
   * Returns a representation of the color as a hexadecimal code,
   ...
   * hexadecimal code, preceded by a '0x', in the format AARRGGBB.
   *
   * @param c the color
   * @return the string
