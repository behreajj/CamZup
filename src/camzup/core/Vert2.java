...
/**
 * Organizes the components of a 2D mesh into a group of coordinate
 * and texture coordinate such that they can be edited together.
 *
...
public class Vert2 implements Comparable < Vert2 > {
  ...
  /**
   * Returns a hash code for this vertex based on its coordinate and
   * texture coordinate.
   *
   * @return the hash
   */
