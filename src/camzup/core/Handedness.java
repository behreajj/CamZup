 ...
 * orientation of the renderer's coordinate axes when a human hand's
 * thumb points out, index finger points forward and middle finger
 * points up. In right handed renderers, a positive angle rotates
