...
public class Complex implements Comparable < Complex >, Cloneable,
  ...
  /**
   * Tests equivalence between this and another complex number. For
   * rough equivalence of floating point components, use the static
   * approximates function instead.
   *
  ...
  /**
   * Returns -1 when this complex number is less than the comparisand; 1
   * when it is greater than; 0 when the two are 'equal'. The
   * implementation of this method allows collections of complex number
   * to be sorted.
   *
  ...
  /**
   * Returns an iterator for this complex number, which allows its
  ...
  /**
   * Attempts to set the components of this complex number from Strings
  ...
  /**
   * Finds the absolute squared of a complex number. Similar to a
  ...
  /**
   * Evaluates whether or not two complex numbers approximate each
   * other.
   *
   * @param a the left comparisand
   * @param b the right comparisand
  ...
  /**
   * Finds the conjugate of the complex number, where the imaginary
   * component is negates.
   *
  ...
  /**
   * Divides one complex number by another. Equivalent to multiplying
  ...
  /**
   * Performs a Mobius transformation on the variable <em>z</em>. Uses
   * the formula <em>a</em> <em>z</em> + <em>b</em> / <em>c</em>
   * <em>z</em> + <em>d</em> <br>
  ...
  public static Complex mobius (
    ...
    /*
     * cz + d -- the denominator -- first. Minimize the number of
     * calculations needed before the function can determine whether or
     * not to return early.
     */
  ...
  /**
   * Raises a complex number to the power of another. Discloses the
   * product and log.
   *
   * @param a      the left operand
   * @param b      the right operand
  ...
  /**
   * Finds the square root of a real number which could be either
