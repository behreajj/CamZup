 ...
 * Processing's PMatrix3D. ALthough this is a 3 x 3 matrix, it is
 * generally assumed to be a 2D affine transform matrix, where the
 * last row is (0.0, 0.0, 1.0) . Instance methods are limited, while
 * most static methods require an explicit output variable to be
 * provided.
 */
public class Mat3 extends Matrix {
   ...
   * matrix array. Works with positive integers in [0, 2][0, 2] or
   * negative integers in [-3, -1][-3, -1].
   *
  ...
  /**
   * Sets the two axis columns of this matrix. The last row and column
   * are set to (0.0, 0.0, 1.0).
   *
   * @param m00 row 0, column 0
   * @param m01 row 0, column 1
   * @param m10 row 1, column 0
  ...
  /**
   * Sets the upper two rows of this matrix. The last row is set to
   * (0.0, 0.0, 1.0).
   *
   * @param m00 row 0, column 0
   * @param m01 row 0, column 1
   ...
   * column is an axis vector, the w or z component is set to 0.0; if it
   * is a translation, the w or z component is set to 1.0.
   *
   * @param j      the column index
   ...
   * is set to 0.0 for a given row, while the element (2, 2) is set to
   * 1.0 .
   *
   * @param i      the row index
  ...
  /**
   * Returns a float array of length 9 containing this matrix's
   * components.
   *
   * @return the array
   */
  ...
  /**
   * Creates a matrix from two axes. The third row and column are
  ...
  /**
   * Creates a matrix from two axes and a translation. The third row, z
   * or w, is assumed to be (0.0, 0.0, 1.0).
   *
   * @param right       the right axis
   * @param forward     the forward axis
  ...
  /**
   * Creates a scale matrix from a scalar. The bottom right corner, m22,
   * is set to 1.0 .
   *
