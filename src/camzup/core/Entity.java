...
/**
 * An entity to be drawn by a renderer, typically holding a transform
 * and some other kind of data.
 */
public abstract class Entity implements IEntity {
  ...
  /**
   * Represents an entity as a class simple name followed by the
   * entity's name.
   *
   * @return the string
   */
