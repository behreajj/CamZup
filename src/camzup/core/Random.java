...
/**
 * An extension of java.util.Random . This is mostly for convenience
...
public class Random extends java.util.Random implements IUtils {
  ...
  /**
   * Returns a double precision real number between 0.0 and the upper
   * bound.
   *
  ...
  /**
   * Returns a single precision real number between 0.0 and the upper
   * bound.
   *
   * @param upper the upper bound
   * @return the random number
  ...
  /**
   * Returns a single precision real number within the lower and upper
   * bound.
   *
   * @param lower the lower bound
   * @param upper the upper bound
