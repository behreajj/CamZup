...
public class CamZup {
   ...
   public static Mesh3 cubeProjectedDodecahedron ( ) {

      final Vec3[] coords = new Vec3[] { /* 0 */ new Vec3(0.0f, 0.31401660f,
         -0.38909327f), /* 1 */ new Vec3(-0.17841116f, 0.44422543f,
            0.14433720f), /* 2 */ new Vec3(0.17841116f, 0.44422543f,
               0.14433720f), /* 3 */ new Vec3(0.28867458f, 0.18534098f,
                  0.36375226f), /* 4 */ new Vec3(-0.28867458f, 0.18534098f,
                     0.36375226f), /* 5 */ new Vec3(-0.17841116f, -0.44422543f,
                        -0.14433720f), /* 6 */ new Vec3(-0.28867458f,
                           -0.36375226f, 0.18534098f), /* 7 */ new Vec3(
                              0.17841116f, -0.44422543f, -0.14433720f),
         /* 8 */ new Vec3(0.28867458f, -0.18534098f, -0.36375226f),
         /* 9 */ new Vec3(0.0f, -0.02534131f, -0.49935741f), /* 10 */ new Vec3(
            0.28867458f, 0.36375226f, -0.18534098f), /* 11 */ new Vec3(
               0.46708646f, 0.05513115f, -0.16967851f), /* 12 */ new Vec3(
                  -0.28867458f, -0.18534098f, -0.36375226f), /* 13 */ new Vec3(
                     -0.46708646f, 0.05513115f, -0.16967851f),
         /* 14 */ new Vec3(-0.28867458f, 0.36375226f, -0.18534098f),
         /* 15 */ new Vec3(0.0f, 0.02534131f, 0.49935741f), /* 16 */ new Vec3(
            0.0f, -0.31401660f, 0.38909327f), /* 17 */ new Vec3(0.28867458f,
               -0.36375226f, 0.18534098f), /* 18 */ new Vec3(0.46708646f,
                  -0.05513115f, 0.16967851f), /* 19 */ new Vec3(-0.46708646f,
                     -0.05513115f, 0.16967851f) };

      final Vec3[] normals = new Vec3[] { /* 0 */ new Vec3(-0.85065031f, 0.5f,
         0.16245960f), /* 1 */ new Vec3(0.0f, 0.97147685f, -0.23713452f),
         /* 2 */ new Vec3(0.0f, -0.97147685f, 0.23713452f), /* 3 */ new Vec3(
            0.0f, -0.64655763f, -0.76286519f), /* 4 */ new Vec3(0.0f,
               0.64655763f, 0.76286519f), /* 5 */ new Vec3(0.52573198f,
                  0.26286548f, -0.80901641f), /* 6 */ new Vec3(-0.52573198f,
                     0.26286548f, -0.80901641f), /* 7 */ new Vec3(-0.52573198f,
                        -0.26286548f, 0.80901641f), /* 8 */ new Vec3(
                           0.52573198f, -0.26286548f, 0.80901641f),
         /* 9 */ new Vec3(0.85065031f, 0.5f, 0.16245960f), /* 10 */ new Vec3(
            0.85065031f, -0.5f, -0.16245960f), /* 11 */ new Vec3(-0.85065031f,
               -0.5f, -0.16245960f) };

      final Vec2[] texCoords = new Vec2[] { /* 0 */ new Vec2(0.69098306f,
         0.66245940f), /* 1 */ new Vec2(0.5f, 0.06205422f), /* 2 */ new Vec2(
            0.69098306f, 1.0f), /* 3 */ new Vec2(0.30901700f, 1.0f),
         /* 4 */ new Vec2(0.5f, 0.52852303f), /* 5 */ new Vec2(0.5f,
            0.14655709f), /* 6 */ new Vec2(0.80901599f, 0.09057724f),
         /* 7 */ new Vec2(0.30901700f, 0.66245940f), /* 8 */ new Vec2(0.0f,
            0.43794692f), /* 9 */ new Vec2(0.19098403f, 0.09057724f),
         /* 10 */ new Vec2(0.5f, 0.93794579f), /* 11 */ new Vec2(0.80901599f,
            0.70861128f), /* 12 */ new Vec2(0.30901700f, 0.33754063f),
         /* 13 */ new Vec2(0.69098306f, 0.33754063f), /* 14 */ new Vec2(
            0.19098403f, 0.70861128f), /* 15 */ new Vec2(0.69098306f, 0.0f),
         /* 16 */ new Vec2(0.30901700f, 0.0f), /* 17 */ new Vec2(0.19098403f,
            0.29138881f), /* 18 */ new Vec2(0.5f, 0.47147697f),
         /* 19 */ new Vec2(0.80901599f, 0.29138881f), /* 20 */ new Vec2(
            0.02582294f, 0.66245940f), /* 21 */ new Vec2(0.30294994f,
               0.90942277f), /* 22 */ new Vec2(1.0f, 0.43794692f),
         /* 23 */ new Vec2(1.0f, 0.56205314f), /* 24 */ new Vec2(0.0f,
            0.56205314f), /* 25 */ new Vec2(0.19098403f, 0.90942277f),
         /* 26 */ new Vec2(0.5f, 0.85344291f), /* 27 */ new Vec2(0.80901599f,
            0.90942277f), /* 28 */ new Vec2(0.89073491f, 0.70861128f),
         /* 29 */ new Vec2(0.97687894f, 0.33754063f), /* 30 */ new Vec2(
            0.69975191f, 0.09057724f), /* 31 */ new Vec2(0.44233492f,
               0.30901754f), /* 32 */ new Vec2(0.56036693f, 0.69098246f),
         /* 33 */ new Vec2(0.11196695f, 0.29138881f) };

      final int[][][] faces = new int[][][] { { { 1, 12, 1 }, { 2, 13, 1 }, {
         10, 11, 1 }, { 0, 10, 1 }, { 14, 14, 1 } }, { { 2, 15, 4 }, { 1, 16,
            4 }, { 4, 17, 4 }, { 15, 18, 4 }, { 3, 19, 4 } }, { { 5, 7, 2 }, {
               7, 0, 2 }, { 17, 19, 2 }, { 16, 1, 2 }, { 6, 17, 2 } }, { { 7, 2,
                  3 }, { 5, 3, 3 }, { 12, 14, 3 }, { 9, 4, 3 }, { 8, 11, 3 } },
         { { 0, 5, 5 }, { 10, 6, 5 }, { 11, 22, 5 }, { 8, 11, 5 }, { 9, 4,
            5 } }, { { 9, 4, 6 }, { 12, 14, 6 }, { 13, 8, 6 }, { 14, 9, 6 }, {
               0, 5, 6 } }, { { 15, 18, 7 }, { 4, 17, 7 }, { 19, 24, 7 }, { 6,
                  25, 7 }, { 16, 26, 7 } }, { { 16, 26, 8 }, { 17, 27, 8 }, {
                     18, 23, 8 }, { 3, 19, 8 }, { 15, 18, 8 } }, { { 10, 28,
                        9 }, { 2, 29, 9 }, { 3, 30, 9 }, { 18, 31, 9 }, { 11,
                           32, 9 } }, { { 17, 33, 10 }, { 7, 20, 10 }, { 8, 21,
                              10 }, { 11, 32, 10 }, { 18, 31, 10 } }, { { 13,
                                 32, 11 }, { 12, 21, 11 }, { 5, 20, 11 }, { 6,
                                    33, 11 }, { 19, 31, 11 } }, { { 19, 31, 0 },
                                       { 4, 30, 0 }, { 1, 29, 0 }, { 14, 28,
                                          0 }, { 13, 32, 0 } } };
