...
/**
 * Maintains consistent behavior between 2D renderers which display
 * text to the screen.
 */
public interface ITextDisplay2 extends ITextDisplay {

  /**
   * Displays a character as text at a 2D location. Ignores the z
   * coordinate.
   *
  ...
  /**
   * Displays an integer as text at a 2D location. Ignores the z
   * coordinate. Registers up to four decimal places.
   *
   * @param i the integer
   * @param x the x coordinate
  ...
  /**
   * Displays a string of text at a 2D location. Ignores the z
   * coordinate.
   *
