...
/**
 * Maintains consistent behavior between renderers which display text
 * to the screen.
 */
public interface ITextDisplay {
  ...
  /**
   * Displays a number as text at a location. Registers up to four
   * decimal places.
   *
   * @param real the real number
   * @param v    the location
  ...
  /**
   * Displays a string at a location. This version of text is not
