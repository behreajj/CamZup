...
public abstract class TextShape {
   ...
   * helper function for other variants of getGlyph.<br>
   * <br>
   * When multiple characters are provided, the kerning between
   * characters is better; when one character is supplied, glyphs with
   * multiple curves (i, j, p, etc.) are easier to organize.
   *
  ...
  protected static List < Curve2 > processGlyphCurve (
     ...
     * where the fore- and rear-handles share a mid point; the 'pen' draws
     * a curved line with different fore- and rear-handles; the pen lifts
     * and stops drawing.
     */
  ...
  /**
   * Converts a list of characters to a an array of curve entities. When
