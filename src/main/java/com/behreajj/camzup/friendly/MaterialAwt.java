...
import com.behreajj.camzup.core.Material;
...
public class MaterialAwt extends Material {
    ...
    public boolean equals(final Object obj) {
        ...
        if (Float.floatToIntBits(this.strokeWeight) != Float.floatToIntBits(other.strokeWeight)) {
            return false;
        }
    ...
    public static class Sample {
        ...
        public boolean equals(final Object obj) {
            ...
            return this.xBottomRight == other.xBottomRight
                && this.xTopLeft == other.xTopLeft
                && this.yBottomRight == other.yBottomRight
