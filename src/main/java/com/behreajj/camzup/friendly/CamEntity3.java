...
import com.behreajj.camzup.core.Entity3;
import com.behreajj.camzup.core.Handedness;
import com.behreajj.camzup.core.Transform3;
...
public class CamEntity3 extends Entity3 {
    ...
    public CamEntity3() {
        ...
        this.transform.moveTo(new Vec3(
            CamEntity3.DEFAULT_LOC_X,
            CamEntity3.DEFAULT_LOC_Y,
            CamEntity3.DEFAULT_LOC_Z));
        this.transform.lookAt(new Vec3(
                CamEntity3.DEFAULT_TARGET_X,
                CamEntity3.DEFAULT_TARGET_Y,
                CamEntity3.DEFAULT_TARGET_Z),
            1.0f, Handedness.RIGHT);
    }
