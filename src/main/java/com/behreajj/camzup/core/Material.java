...
public abstract class Material extends EntityData {
    ...
    /**
     * The default stroke color used when none is specified. Expressed as a 32-bit
     * integer formatted
     * as 0xAARRGGBB.
     */
    ...
    /**
     * The default fill color used when none is specified, (0.6039, 0.8471, 0.8863)
     * in RGB. Expressed
     * as a 32-bit integer formatted as 0xAARRGGBB.
     */
