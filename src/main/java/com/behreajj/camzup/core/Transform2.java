 ...
 */
public class Transform2 implements Comparable<Transform2>, ISpatial2, IOriented2, IVolume2 {
     ...
     */
    public static final float DEFAULT_RND_SCL_LB = Utils.ONE_SQRT_2;

    /**
     * Default random scale upper bound for creating a random transform.
     */
    public static final float DEFAULT_RND_SCL_UB = Utils.SQRT_2;
     ...
     */
    public Transform2(final Vec2 location, final float rotation, final Vec2 scale) {
     ...
     * @see Vec2#normalize(Vec2, Vec2)
     */
    public static Ray2 invMul(final Transform2 t, final Ray2 source, final Ray2 target) {
     ...
     */
    public static Vec2 invMulDir(final Transform2 t, final Vec2 source, final Vec2 target) {
     ...
     */
    public static Vec2 invMulPoint(final Transform2 t, final Vec2 source, final Vec2 target) {
     ...
     * @see Vec2#rotateZ(Vec2, float, Vec2)
     */
    public static Vec2 invMulVector(final Transform2 t, final Vec2 source, final Vec2 target) {
    ...
    public static float maxDimension(final Transform2 t) {
        ...
        return Math.max(Utils.abs(t.scale.x), Utils.abs(t.scale.y));
    }
    ...
    public static float minDimension(final Transform2 t) {
        ...
        return Math.min(Utils.abs(t.scale.x), Utils.abs(t.scale.y));
    }
     ...
     * @see Vec2#normalize(Vec2, Vec2)
     */
    public static Ray2 mul(final Transform2 t, final Ray2 source, final Ray2 target) {
     ...
     */
    public static Vec2 mulCurveSeg(
        final Transform2 t,
        final Vec2 fhSrc,
        final Vec2 rhSrc,
        final Vec2 coSrc,
     ...
     * @see Vec2#rotateZ(Vec2, float, Vec2)
     */
    public static Vec2 mulDir(final Transform2 t, final Vec2 source, final Vec2 target) {
     ...
     * @return the point
     */
    public static Vec2 mulPoint(final Transform2 t, final Vec2 source, final Vec2 target) {
     ...
     */
    public static Vec2 mulTexCoord(final Transform2 t, final Vec2 source, final Vec2 target) {
     ...
     * @see Vec2#rotateZ(Vec2, float, Vec2)
     */
    public static Vec2 mulVector(final Transform2 t, final Vec2 source, final Vec2 target) {
     ...
     */
    public static Transform2 random(
     ...
     * {@value Transform2#DEFAULT_RND_LOC_UB}] . The scale range is [{@value
     * Transform2#DEFAULT_RND_SCL_LB}, {@value Transform2#DEFAULT_RND_SCL_UB}] .
     *
     * @param rng    the random number generator
     * @param target the output transform
     * @return the random transform
     */
    public static Transform2 random(final java.util.Random rng, final Transform2 target) {

        return Transform2.random(
            rng,
            Transform2.DEFAULT_RND_LOC_LB,
            Transform2.DEFAULT_RND_LOC_UB,
            -Utils.PI,
            Utils.PI,
            Transform2.DEFAULT_RND_SCL_LB,
            Transform2.DEFAULT_RND_SCL_UB,
            target);
    }

    /**
     * Creates a random transform. Uses
     * {@link Vec2#randomCartesian(java.util.Random, Vec2, Vec2,
     * Vec2)} for location and scale.
     *
     * @param rng    the random number generator
     * @param lbLoc  the location lower bound
    ...
    public static float rotDelta(final Transform2 t) {
        ...
        final float diff = (t.rotation - t.rotPrev + Utils.PI) % Utils.TAU - Utils.PI;
        return diff < -Utils.PI ? diff + Utils.TAU : diff;
    }
    ...
    public boolean equals(final Object o) {
        ...
        return this.equals((Transform2) o);
    }
     ...
     * @see Vec2#any(Vec2)
     */
    public Transform2 set(final Vec2 locNew, final float radians, final Vec2 scaleNew) {
    ...
    void toSvgString(final StringBuilder svgp) {
        ...
        svgp.append(") rotate(");
        Utils.toFixed(svgp, Utils.modRadians(this.rotation) * Utils.RAD_TO_DEG, 0);
        svgp.append(") scale(");
    ...
    public static class Easing
        ...
        public Easing() {
            ...
            this.rot = new Utils.LerpNear(Utils.TAU);
