...
public class Rgb implements IColor {
     ...
     * @return the evaluation
     */
    public static boolean any(final Rgb c) {
        return c.alpha > 0.0f;
    }
        ...
        try {
            switch (len) {
                ...
                case 6: {
                    ...
                    final int c16 = Integer.parseInt(cVerif, 16);
                    return target.set(
                        (c16 >> 0x10 & 0xff) / 255.0f,
                        (c16 >> 0x08 & 0xff) / 255.0f,
                        (c16 & 0xff) / 255.0f,
                        1.0f);
                }
                ...
                case 8: {
                    ...
                    return target.set(
                        (c16 >> 0x10L & 0xffL) / 255.0f,
                        (c16 >> 0x08L & 0xffL) / 255.0f,
                        (c16 & 0xffL) / 255.0f,
                        (c16 >> 0x18L & 0xffL) / 255.0f);
                }
     ...
     * @return the evaluation
     */
    public static boolean none(final Rgb c) {
        return c.alpha <= 0.0f;
    }
     ...
     */
    public static StringBuilder toHexWeb(final StringBuilder sb, final int c) {
    ...
    public static StringBuilder toHexWeb(
        final StringBuilder sb, final int r, final int g, final int b) {
    ...
    public static String toString(final Rgb[] arr) {
        ...
        return Rgb.toString(arr, Utils.FIXED_PRINT);
    }
    ...
    void toBlenderCode(final StringBuilder pyCd, final float gamma) {
        ...
        pyCd.append(',');
        pyCd.append(' ');
        Utils.toFixed(pyCd, (float) Math.pow(Utils.clamp01(this.g), gamma), 6);
        pyCd.append(',');
        pyCd.append(' ');
