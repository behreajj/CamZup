...
public class Lab implements IColor {
     ...
     * @param alpha the alpha channel
     */
    public Lab(final float l, final float a, final float b, final float alpha) {
     ...
     * @param alpha the alpha channel
     */
    public Lab(final short l, final short a, final short b, final short alpha) {
     ...
     * @see Lab#gray(Lab, Lab)
     */
    public static Lab adoptChroma(final Lab u, final Lab o, final Lab target) {

        final double ua = u.a;
        final double ub = u.b;
        final double ucSq = ua * ua + ub * ub;
        if (ucSq > Utils.EPSILON_D) {
            final double oa = o.a;
            final double ob = o.b;
            final double ocSq = oa * oa + ob * ob;

            final double s = Math.sqrt(ocSq) / Math.sqrt(ucSq);
            return target.set(u.l, (float) (s * ua), (float) (s * ub), u.alpha);
        }
    ...
    public static Lab adoptHue(final Lab u, final Lab o, final Lab target) {
        ...
        final double ob = o.b;
        final double ocSq = oa * oa + ob * ob;
        if (ocSq > Utils.EPSILON_D) {
            final double ua = u.a;
            final double ub = u.b;
            final double ucSq = ua * ua + ub * ub;

            final double s = Math.sqrt(ucSq) / Math.sqrt(ocSq);
            return target.set(u.l, (float) (s * oa), (float) (s * ob), u.alpha);
        }
        return Lab.gray(u, target);
    }
     ...
     * @return the evaluation
     */
    public static boolean any(final Lab o) {
        return o.alpha > 0.0f;
    }
     ...
     * @return the chroma
     */
    public static Vec2 chroma(final Lab o, final Vec2 target) {

        return target.set(o.a, o.b);
    }
     ...
     * @see Math#sqrt(double)
     */
    public static float dist(final Lab o, final Lab d, final float alphaScalar) {
     ...
     * @see Math#sqrt(double)
     */
    public static float distEuclidean(final Lab o, final Lab d, final float alphaScalar) {
    ...
    public static Lab[] flat(final Lab[][][] arr) {
        ...
        int k = 0;
        final Lab[] result = new Lab[totalLen];
        for (final Lab[][] arrInner1 : arr) {
            for (final Lab[] arrInner2 : arrInner1) {
    ...
    public static float hueBetween(final Lab o, final Lab d) {
        ...
        if (ocSq < Utils.EPSILON_D || dcSq < Utils.EPSILON_D) {
            return 0.0f;
        }

        final double num = oa * da + ob * db;
        final double denom = Math.sqrt(ocSq) * Math.sqrt(dcSq);
        return (float) (Math.acos(num / denom) / Utils.TAU_D);
    }
     ...
     * @return the evaluation
     */
    public static boolean none(final Lab o) {
        return o.alpha <= 0.0f;
    }
     ...
     * @see Lab#gray(Lab, Lab)
     */
    public static Lab rescaleChroma(final Lab o, final float scalar, final Lab target) {

        final double oa = o.a;
        final double ob = o.b;
        final double cSq = oa * oa + ob * ob;
        if (cSq > Utils.EPSILON_D) {
            final double s = scalar / Math.sqrt(cSq);
            return target.set(o.l, (float) (s * oa), (float) (s * ob), o.alpha);
        }
     ...
     * @see Math#sin(double)
     */
    public static Lab rotateHue(final Lab o, final float amount, final Lab target) {

        final double ad = o.a;
        final double bd = o.b;
        final double hRad = amount * Utils.TAU_D;
     ...
     */
    public static Lab scaleChroma(final Lab o, final float scalar, final Lab target) {
    ...
    /**
     * Converts from SR LAB 2 to SR XYZ. The alpha component is assigned to w. See
     * <a href=
     * "https://www.magnetkern.de/srlab2.html">https://www.magnetkern.de/srlab2.html</a>.
     *
     ...
     * @return the color
     */
    static Lab fromScalar(final float scalar, final Lab target) {
     ...
     * @return this color
     */
    public Lab set(final float l, final float a, final float b, final float alpha) {
    ...
    public int toHexIntSat() {
        ...
        final int l8 = (int) (Utils.clamp(this.l, 0.0f, 100.0f) * Lab.L_TO_BYTE + 0.5f);
     ...
     * @return the color in hexadecimal
     */
    public long toHexLong() {
        return this.toHexLongWrap();
    }
     ...
     */
    public abstract static class AbstrEasing implements Utils.EasingFuncObj<Lab> {
     ...
     */
    public abstract static class AbstrHarmony implements Function<Lab, Lab[]> {
    ...
    public static class HarmonyAnalogous extends AbstrHarmony {
        ...
        public Lab[] apply(final Lab o) {
            ...
            final double rt32ca = Utils.SQRT_3_2_D * ad;
            final double rt32cb = Utils.SQRT_3_2_D * bd;
     ...
     */
    public static class MixLch extends AbstrEasing {
