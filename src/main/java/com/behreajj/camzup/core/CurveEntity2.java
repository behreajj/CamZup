...
/**
 * An entity which contains a transform that is applied to a list of curves.
 */
public class CurveEntity2 extends Entity2 implements Iterable<Curve2>, IVolume2, ISvgWritable {
     ...
     * @param curves    the list of curves
     */
    public CurveEntity2(final String name, final Transform2 transform, final Curve2... curves) {
     ...
     * @return the bounds
     */
    public static Bounds2 calcBounds(final CurveEntity2 entity, final Bounds2 target) {
    ...
    public CurveEntity2 reframe() {
        ...
        while (crvItr.hasNext()) {
            Curve2.accumMinMax(crvItr.next(), lb, ub);
        }
     ...
     * @return the curve
     */
    public Curve2 removeAt(final int i) {
    ...
    public CurveEntity2 toOrigin() {
        ...
        while (itr.hasNext()) {
            Curve2.accumMinMax(itr.next(), lb, ub);
        }
    ...
    public String toSvgElm(final float zoom) {
        ...
        return this.toSvgElm(zoom, true, ISvgWritable.DEFAULT_STROKE_CAP,
            ISvgWritable.DEFAULT_STROKE_JOIN, ISvgWritable.DEFAULT_MITER_LIMIT,
            new MaterialSolid[]{});
    }
    ...
    public String toSvgElm(
        ...
        return this.toSvgElm(zoom, useSubPaths, strokeCap, strokeJoin, miterLimit, new MaterialSolid[]{material});
    }
    ...
    public String toSvgElm(
        ...
        if (!includesMats) {
            ...
            svgp.append("<g ");
            materials[0].toSvgString(svgp, scale, strokeCap, strokeJoin, miterLimit);
            svgp.append('>');
            svgp.append('\n');
        }
        ...
        if (!multipleMats && useSubPaths) {
            ...
            for (final Curve2 curve : this.curves) {
                ...
                if (multipleMats) {
                    ...
                    svgp.append("<g ");
                    material.toSvgString(svgp, scale, strokeCap, strokeJoin, miterLimit);
                    svgp.append('>');
                    svgp.append('\n');
                }
