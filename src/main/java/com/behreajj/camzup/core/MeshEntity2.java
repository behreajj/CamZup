...
public class MeshEntity2 extends Entity2 implements Iterable<Mesh2>, IVolume2, ISvgWritable, IBlenderWritable {
    ...
    public String toSvgElm(final float zoom) {
        ...
        return this.toSvgElm(zoom, ISvgWritable.DEFAULT_STROKE_CAP,
            ISvgWritable.DEFAULT_STROKE_JOIN,
            ISvgWritable.DEFAULT_MITER_LIMIT, new MaterialSolid[]{});
    }
    ...
    public String toSvgElm(
        ...
        return this.toSvgElm(zoom, strokeCap, strokeJoin, miterLimit,
            new MaterialSolid[]{material});
    }
