...
public class Face2 implements Iterable<Edge2>, Comparable<Face2> {
     ...
     */
    public Face2(final Edge2... edges) {
        this.set(edges);
    }
    ...
    public static float areaSigned(final Face2 face) {
        ...
        for (int i = 1; i < last; ++i) {
            sum += verts[i].coord.x * (verts[i + 1].coord.y - verts[i - 1].coord.y);
        }
        sum += verts[last].coord.x * (verts[0].coord.y - verts[last - 1].coord.y);
    ...
    /**
     * Evaluates whether the face contains a point. Uses vertex winding (as opposed
     * to casting a ray).
     *
     * @param face  the face
     ...
     */
    public static Vec2 eval(final Face2 face, final float step, final Vec2 target) {
    ...
    public static Vec2[] sharedCoords(final Face2 a, final Face2 b) {
        ...
        return aList.toArray(new Vec2[0]);
    }
    ...
    public int compareTo(final Face2 face) {
        ...
        return Face2.centerMean(this, new Vec2()).compareTo(Face2.centerMean(face, new Vec2()));
    }
     ...
     * @return the iterator
     */
    public Edge2Iterator edgeIterator() {
        return new Edge2Iterator(this);
    }
     ...
     * @see Vec2#add(Vec2, Vec2, Vec2)
     */
    public Face2 rotateZLocal(final float cosa, final float sina, final Vec2 center) {
     ...
     * @return the iterator
     */
    public Vert2Iterator vertIterator() {
        return new Vert2Iterator(this);
    }
    ...
    public static final class Edge2Iterator implements Iterator<Edge2> {
         ...
         */
        public Edge2Iterator(final Face2 face) {
            this.face = face;
        }
    ...
    public static final class Vert2Iterator implements Iterator<Vert2> {
         ...
         * @param face the face to iterate
         */
        public Vert2Iterator(final Face2 face) {
            this.face = face;
        }
