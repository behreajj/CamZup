...
public class Lch implements IColor {
     ...
     * @param alpha the alpha channel
     */
    public Lch(final float l, final float c, final float h, final float alpha) {
     ...
     * @return the evaluation
     */
    public static boolean any(final Lch o) {
        return o.alpha > 0.0f;
    }
    ...
    public static Lch mix(
        ...
        final boolean oIsGray = orig.c < Utils.EPSILON;
        ...
        if (oIsGray || dIsGray) {
            ...
            double ob = 0.0d;
            if (!oIsGray) {
                final double ohRadians = orig.h * Utils.TAU_D;
            ...
            double db = 0.0d;
            if (!dIsGray) {
                final double dhRadians = dest.h * Utils.TAU_D;
     ...
     * @return the evaluation
     */
    public static boolean none(final Lch o) {
        return o.alpha <= 0.0f;
    }
    ...
    public static Lch random(final Random rng, final Lch target) {
        ...
        return target.set(
            ...
            (1.0f - rc) * Lch.RNG_C_MIN + rc * Lch.RNG_C_MAX,
            rh,
            1.0f);
    }
     ...
     * @return this color
     */
    public Lch set(final float l, final float c, final float h, final float alpha) {
    ...
    public int toHexIntSat() {
        ...
        final int c8 = (int) (Utils.clamp(this.c * Lch.C_TO_BYTE, 0.0f, 254.5f) + 0.5f);
     ...
     */
    public abstract static class AbstrHarmony implements Function<Lch, Lch[]> {
