...
public abstract class ParserObj {
     ...
     */
    public static MeshEntity3 load(final BufferedReader in, final boolean poolData) {
        ...
        final HashMap<String, ArrayList<int[][]>> faceGroups = new HashMap<>(groupCapacity, 0.75f);
                        ...
                        switch (cmd) {
                            ...
                            case 103: /* "g" */
                                ...
                                if (!faceGroups.containsKey(gName)) {
                                    faceGroups.put(gName, new ArrayList<>(indicesCapacity));
                                }
                            ...
                            case 3774: /* "vt" */
                                texCoordList.add(
                                    new Vec2(Float.parseFloat(tokens[1]), Float.parseFloat(tokens[2])));
        ...
        if (groupsMissing) {
            ...
            for (final Entry<String, ArrayList<int[][]>> entry : faceGroups.entrySet()) {
    ...
    /**
     * Creates a mesh entity from a file name that references a WaveFront .obj file
     * with groups. In
     * doing so, makes a {@link FileReader} that is wrapped in a
     * {@link BufferedReader}.
     *
