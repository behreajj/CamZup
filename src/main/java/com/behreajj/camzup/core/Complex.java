...
public class Complex implements Comparable<Complex> {
     ...
     *
     * @param z the source complex number
     */
    ...
    /**
     * Evaluates whether two complex numbers approximate each other.
     *
    ...
    public static boolean approx(final Complex a, final Complex b) {
        ...
        return Complex.approx(a, b, Utils.EPSILON);
    }
     ...
     */
    public static Complex div(final float a, final Complex b, final Complex target) {
    ...
    public static Complex[] flat(final Complex[][] arr) {
        ...
        for (final Complex[] arrInner : arr) {
    ...
    public static Complex mobius(
         ...
         * before the function can determine whether to return early.
         */
     ...
     * @return the product
     */
    public static Complex mul(final Complex a, final float b, final Complex target) {
     ...
     * @return the product
     */
    public static Complex mul(final float a, final Complex b, final Complex target) {
     ...
     * @return the random complex number
     */
    public static Complex random(final Random rng, final float radius, final Complex target) {
        ...
        if (abSq != 0.0d) {
            ...
            return target.set((float) (zr * absInv), (float) (zi * absInv));
        }
        return target.reset();
    }
