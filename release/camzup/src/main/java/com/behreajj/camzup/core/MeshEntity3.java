 ...
 */
public class MeshEntity3 extends Entity3 implements Iterable<Mesh3>, IVolume3, IBlenderWritable {
     ...
     * @param meshes    the list of meshes
     */
    public MeshEntity3(final String name, final Transform3 transform, final Mesh3... meshes) {
     ...
     * @return the bounds
     */
    public static Bounds3 calcBounds(final MeshEntity3 me, final Bounds3 target) {
    ...
    public MeshEntity3 reframe() {
        ...
        while (itr.hasNext()) {
            Mesh3.accumMinMax(itr.next(), lb, ub);
        }
     ...
     * @return the mesh
     */
    public Mesh3 removeAt(final int i) {
