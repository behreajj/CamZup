...
import com.behreajj.camzup.core.Quaternion;
...
public abstract class PMatAux {
    ...
    public static String toString(final PMatrix2D m) {
        ...
        return PMatAux.toString(m, Utils.FIXED_PRINT);
    }
    ...
    public static String toString(final PMatrix2D m, final int places) {
        ...
        return "\n" +
            '[' +
            ' ' +
            Utils.toFixed(m.m00, places) + ',' + ' ' +
            Utils.toFixed(m.m01, places) + ',' + ' ' +
            Utils.toFixed(m.m02, places) +
            ',' +
            ' ' +
            '\n' +
            Utils.toFixed(m.m10, places) + ',' + ' ' +
            Utils.toFixed(m.m11, places) + ',' + ' ' +
            Utils.toFixed(m.m12, places) +
            ' ' +
            ']' +
            '\n';
    }
    ...
    public static String toString(final PMatrix3D m, final int places) {
        ...
        return "\n" +
            ...
            Utils.toFixed(m.m01, places) + ',' + ' ' +
            Utils.toFixed(m.m02, places) + ',' + ' ' +
            Utils.toFixed(m.m03, places) + ',' + ' ' +
            '\n' +
            Utils.toFixed(m.m10, places) + ',' + ' ' +
            Utils.toFixed(m.m11, places) + ',' + ' ' +
            Utils.toFixed(m.m12, places) + ',' + ' ' +
            Utils.toFixed(m.m13, places) + ',' + ' ' +
            '\n' +
            Utils.toFixed(m.m20, places) + ',' + ' ' +
            Utils.toFixed(m.m21, places) + ',' + ' ' +
            Utils.toFixed(m.m22, places) + ',' + ' ' +
            Utils.toFixed(m.m23, places) + ',' + ' ' +
            '\n' +
            Utils.toFixed(m.m30, places) + ',' + ' ' +
            Utils.toFixed(m.m31, places) + ',' + ' ' +
            Utils.toFixed(m.m32, places) + ',' + ' ' +
