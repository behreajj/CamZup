...
public abstract class UpOgl extends PGraphicsOpenGL implements IUpOgl {
    ...
    public void arc(
        ...
        Curve2.arc(start, stop, Math.min(Utils.abs(r0), Utils.abs(r1)),
        ...
        switch (this.colorMode) {
            case PConstants.HSB: { /* 3 */
                final float[] rgb = ColorAux.hsbToRgb(
                    this.calcR, this.calcG, this.calcB);
                this.calcB = rgb[2];
                this.calcG = rgb[1];
                this.calcR = rgb[0];
            }
    ...
    public void colorCalc(final int argb, final boolean premul) {
        ...
        this.calcA = Utils.ONE_255 * (argb >> 0x18 & 0xff);
        this.calcB = Utils.ONE_255 * (argb & 0xff);
        this.calcG = Utils.ONE_255 * (argb >> 0x08 & 0xff);
        this.calcR = Utils.ONE_255 * (argb >> 0x10 & 0xff);
    ...
    public void ellipseImpl(final float x, final float y, final float w,
        ...
        /*
         * This needs to be implemented to resolve a bug with CORNER. All
         * ellipse functions should perform no work, but redirect immediately
         * here.
         */
        ...
        switch (this.ellipseMode) {
            case PConstants.CORNER: /* 0 */
                ...
                extapw = 0.5f * w;
                extcpw = Curve.KAPPA_2 * w;
                extaph = 0.5f * h;
                extcph = Curve.KAPPA_2 * h;
            ...
            case PConstants.CORNERS: /* 1 */
                ...
                extapw = 0.5f * wcalc;
                extcpw = Curve.KAPPA_2 * wcalc;
                extaph = 0.5f * hcalc;
                extcph = Curve.KAPPA_2 * hcalc;
            ...
            case PConstants.RADIUS: /* 2 */
                ...
                extapw = w;
                extcpw = Curve.KAPPA * extapw;
                extaph = h;
                extcph = Curve.KAPPA * extaph;
    ...
    public void enableDepthMask() {
        ...
        /*
         * Paired constants have signed values: PConstants#ENABLE_DEPTH_MASK
    ...
    public void enableDepthTest() {
        ...
        /*
         * Paired constants have signed values: PConstants#ENABLE_DEPTH_TEST
         * has a negative value.
         */
    ...
    public void enableMipMaps() {
        ...
        /*
         * Paired constants have signed values:
         * PConstants#ENABLE_TEXTURE_MIPMAPS has a negative value.
         */
    ...
    public void enableOptimizedStroke() {
        ...
        /*
         * Paired constants have signed values:
         * PConstants#ENABLE_OPTIMIZED_STROKE has a negative value.
         */
    ...
    /**
     * Gets whether normals are calculated in
     * {@link PGraphicsOpenGL#vertex(float, float, float)} and variants.
     *
     * @return the flag
     */
    public boolean getAutoNormal() {
        return this.autoNormal;
    }

    /**
     * Sets whether to automatically calculate normals when
    ...
    public void image(final PImage img, final float x, final float y) {
        ...
        switch (this.imageMode) {
            case PConstants.CORNER: /* 0 */
            case PConstants.CORNERS: { /* 1 */
                this.imageCorner(img, x, y, img.width, img.height, 0.0f, 0.0f,
                    0.0f, u, v);
            }
            break;
            ...
            case PConstants.CENTER: /* 3 */
            default: {
                this.imageCenter(img, x, y, img.width, img.height, 0.0f, 0.0f,
                    0.0f, u, v);
            }
        }
    }
    ...
    public void image(final PImage img, final float x1, final float y1,
        ...
        /*
         * Off-by-one issue when texture sampling is set to POINT and the image
         * is displayed in the center as opposed to the top left corner.
         * Drawing four quadrants instead of just one does not fix the issue.
         */
    ...
    public void image(
        ...
        // TODO: Shouldn't this be 1/(w-1) instead of 1/w?
    ...
    /**
     * Returns whether depth sorting is enabled.
     *
    ...
    public void printCamera() {
        this.printCamera(Utils.FIXED_PRINT);
    }
    ...
    public void printCameraInv() {
        this.printCameraInv(Utils.FIXED_PRINT);
    }
    ...
    public void printProjection() {
        this.printProjection(Utils.FIXED_PRINT);
    }
    ...
    public void setMatrix(
        ...
        /*
         * The parent method is to reset, then apply. This is backwards,
         * resetting and multiplication should depend on setting, not the other
         * way around. The point is to avoid matrix multiplication when
         * possible.
         */
        this.camera.set(
            1.0f, 0.0f, 0.0f, 0.0f,
    ...
    public void setSize(final int width, final int height) {
        ...
        this.defCameraZ = (float) height * Utils.cot(this.defCameraFOV * 0.5f);
        this.defCameraNear = this.defCameraZ * 0.01f;
        this.defCameraFar = this.defCameraZ * 10.0f;
        this.defCameraAspect = this.width / (float) height;
    ...
    public void stroke(final Rgb c) {
        ...
        /*
         * strokeFromCalc is not overridden in the OpenGL, so it calls the
         * method from PGraphics, which assigns calculated color variables to
    ...
    public void tint(final Rgb c) {
         ...
         * from PGraphics, which assigns calculated color variables to tint
         * color variables.
         */
    ...
    public void strokeJoin(final int join) {
         ...
         * https://discourse.processing.org/t/drawing-a-flower-of-life-with-6-vesica-
         * piscis/46341/
         * https://github.com/processing/processing4/blob/main/core/src/processing/
         * opengl/PGraphicsOpenGL.java#L13905
         */
    ...
    void imageCorner(final PImage img, final float xtl, final float ytl,
        ...
        this.normalPerShape(0.0f, 0.0f, 1.0f);
        this.texture(img);
        this.vertexImpl(xtl, ytl, z, u1, v1);
        this.vertexImpl(right, ytl, z, u2, v1);
        this.vertexImpl(right, bottom, z, u2, v2);
        this.vertexImpl(xtl, bottom, z, u1, v2);
        this.endShape(PConstants.CLOSE);
        this.textureWrap(oldWrapMode);
        this.popStyle();
    }
    ...
    void imageCorners(final PImage img, final float x1, final float y1,
        ...
        final float top = Math.max(y1, y2);
        final float right = Math.max(x1, x2);
        final float bottom = Math.min(y1, y2);
    ...
    protected void colorCalcARGB(final int rgb, final float alpha) {
        ...
        this.colorCalc(
            (int) (0.5f + 0xff * alpha * this.invColorModeA) << 0x18
                | rgb & 0x00ffffff,
            this.usePreMultiply);
    }
    ...
    protected void drawCurve2(
        ...
        while (itr.hasNext()) {
            final Knot2 currKnot = itr.next();
            Transform2.mulCurveSeg(tr, prevKnot.foreHandle,
                currKnot.rearHandle, currKnot.coord, fh, rh, co);
            this.bezierVertexImpl(
                fh.x, fh.y, 0.0f,
                rh.x, rh.y, 0.0f,
                co.x, co.y, 0.0f);
        ...
        if (curve.closedLoop) {
            Transform2.mulCurveSeg(tr, prevKnot.foreHandle,
                firstKnot.rearHandle, firstKnot.coord, fh, rh, co);
            this.bezierVertexImpl(
                fh.x, fh.y, 0.0f,
                rh.x, rh.y, 0.0f,
                co.x, co.y, 0.0f);
    ...
    protected void drawCurve3(
        ...
        while (itr.hasNext()) {
            ...
            Transform3.mulCurveSeg(tr, prevKnot.foreHandle,
                currKnot.rearHandle, currKnot.coord, fh, rh, co);
            this.bezierVertexImpl(
                fh.x, fh.y, fh.z,
                rh.x, rh.y, rh.z,
    ...
    protected void drawMesh2(final Mesh2 mesh, final Transform2 tr,
        ...
        for (final int[][] f : fs) {
            ...
            for (final int[] verts : f) {
                ...
                Transform2.mulTexCoord(uvtr, vts[verts[1]], vt);
    ...
    protected void drawMesh3(final Mesh3 mesh, final Transform3 tr,
        ...
        for (final int[][] f : fs) {
            ...
            for (final int[] verts : f) {
                Transform3.mulPoint(tr, vs[verts[0]], v);
                Transform2.mulTexCoord(uvtr, vts[verts[1]], vt);
                Transform3.mulNormal(tr, vns[verts[2]], vn);
                this.normalX = vn.x;
                this.normalY = vn.y;
                this.normalZ = vn.z;
    ...
    protected void lightSpot(final int num, final float radians,
        ...
        this.lightSpotParameters[num2] = Math.max(0.0f, (float) Math.cos(
            radians));
     ...
     */
    @Override
    protected void rectImpl(final float x0, final float y0,
        final float x1, final float y1) {
    ...
    protected void rectImpl(
        ...
        final float x1, final float y1,
        final float topLeft, final float topRight,
        ...
        final float limit = Math.min(w, h) * 0.5f;
        c0 = Utils.clamp(c0, Utils.EPSILON, limit);
        c1 = Utils.clamp(c1, Utils.EPSILON, limit);
        c2 = Utils.clamp(c2, Utils.EPSILON, limit);
        c3 = Utils.clamp(c3, Utils.EPSILON, limit);
