...
Cam Z-Up is tested with Processing version [4.x](https://github.com/processing/processing4/releases). It's been around for a while, so it was overhauled to use the accepted [library template](https://discourse.processing.org/t/a-new-processing-library-template/45390/5) on March 19, 2025,  this [commit](https://github.com/behreajj/CamZup/commit/e2441d5ecb2c92cf2a705f860a767e1d9a507259).
