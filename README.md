...
- Quaternions, when used to store rotations, are typically of unit length. Care should be taken that any operation which alters a quaternion's magnitude is followed by `normalize`.
